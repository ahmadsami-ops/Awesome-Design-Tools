...
- [FreeColorPalettes.co](https://freecolorpalettes.co) — color palette generator with harmony modes (analogous, complementary, triadic, monochromatic). Includes WCAG contrast checker, color blindness simulator, tints & shades scale, image-to-palette extractor, and CSS gradient generator. Export as HEX, CSS variables, Tailwind config, SCSS, or JSON. ![free.svg](https://github.com/LisaDziuba/Awesome-Design-Tools/blob/master/Media/free.svg)
